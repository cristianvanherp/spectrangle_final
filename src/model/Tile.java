...
public class Tile {
	...
	// ------------------CONSTRUCTORS---------------------
	// ***************************************************
	public Tile(Orientation orientation, char colorLeft, 
			char colorRight, char colorVertical, int points) {
	...
	// ***************************************************
	public void rotate() {
		char auxLeft = this.colorLeft, 
				auxRight = this.colorRight, auxVertical = this.colorVertical;

		if (this.orientation.equals(Orientation.UP)) {
			this.orientation = Orientation.DOWN;
			this.colorLeft = auxVertical;
			this.colorRight = auxRight;
			this.colorVertical = auxLeft;
		} else {
			this.orientation = Orientation.UP;
			this.colorLeft = auxLeft;
			this.colorRight = auxVertical;
			this.colorVertical = auxRight;
		}
	...
	public String toString() {
		if (this.orientation.equals(Orientation.UP)) {
			return String.valueOf(this.colorRight) + 
					String.valueOf(this.colorVertical) + String.valueOf(this.colorLeft)
						+ this.points.toString();
		} else {
			return String.valueOf(this.colorVertical) + 
					String.valueOf(this.colorRight) + String.valueOf(this.colorLeft)
					+ this.points.toString();
		}
	}
	...
	private void updateDrawing() {
		...
		if (this.orientation.equals(Orientation.UP)) {
			...
			this.drawingLines.add("    / \\     ");
			this.drawingLines.add("   /   \\    ");
			this.drawingLines.add("  /" + String.valueOf(this.colorLeft) + " " + this.points + " "
					+ String.valueOf(this.colorRight) + "\\   ");
			...
			this.drawingLines.add(" \\   " + String.valueOf(this.colorVertical) + "   /  ");
			this.drawingLines.add("  \\" 
					+ String.valueOf(this.colorLeft) + " " + String.valueOf(this.points) + " "
						+ String.valueOf(this.colorRight) + "/   ");
			this.drawingLines.add("   \\   /    ");
			this.drawingLines.add("    \\ /     ");
